...
\geometry{left=1.2cm,right=1.2cm,top=1.25cm,bottom=1.25cm,columnsep=1.2cm,paperheight=18.5in}
...
A full-stack engineer developing some of the first REST APIs for credit card resources and helped build the \href{https://developer.capitalone.com}{API Developer Portal} - the banking industry's first public APIs.
...
\cvachievement{\faUsers}{People leadership}{Leading globally distributed teams through both tranquil and chaotic times.}

\cvachievement{\faTrophy}{Achievements}{Patents and tech excellence awards}

\cvachievement{\faChartLine}{Tech organization growth}{Contributed to organizational growth at Storyblocks, Capital One, and Twitter}
